/**
 * \file        as5600_defs.h
 * \brief       AS5600 magnetic encoder definitions and constants
 * \details     Register addresses, configuration structures, and enumerations
 * \author      MaverickST
 * \version     0.0.3
 * \date        2025
...
#ifndef AS5600_DEFS_H
#define AS5600_DEFS_H
...
typedef enum 
{
    ...
    AS5600_REG_ZPOS_H = 0x01,      ///< Zero-Position Offset high byte
    AS5600_REG_ZPOS_L = 0x02,      ///< Zero-Position Offset low byte
    AS5600_REG_MPOS_H = 0x03,      ///< Magnet Position high byte
    AS5600_REG_MPOS_L = 0x04,      ///< Magnet Position low byte
    AS5600_REG_MANG_H = 0x05,      ///< Magnet Angle high byte
    AS5600_REG_MANG_L = 0x06,      ///< Magnet Angle low byte
    AS5600_REG_CONF_H = 0x07,      ///< Configuration high byte
    AS5600_REG_CONF_L = 0x08,      ///< Configuration low byte
    AS5600_REG_STATUS = 0x0B,      ///< Status register
    AS5600_REG_RAW_ANGLE_H = 0x0C, ///< Raw Angle high byte
    AS5600_REG_RAW_ANGLE_L = 0x0D, ///< Raw Angle low byte
    AS5600_REG_ANGLE_H = 0x0E,     ///< Angle high byte
    AS5600_REG_ANGLE_L = 0x0F,     ///< Angle low byte
    AS5600_REG_AGC = 0x1A,         ///< Automatic Gain Control
    AS5600_REG_MAGNITUDE_H = 0x1B, ///< Magnitude high byte
    AS5600_REG_MAGNITUDE_L = 0x1C, ///< Magnitude low byte
    AS5600_REG_BURN = 0xFF         ///< BURN register
} as5600_reg_t;
...
// Bitfield constant values
#define AS5600_CONF_PM_NOM      0x00
#define AS5600_CONF_PM_LPM1     0x01
#define AS5600_CONF_PM_LPM2     0x02
#define AS5600_CONF_PM_LPM3     0x03

#define AS5600_CONF_HYST_OFF    0x00
#define AS5600_CONF_HYST_1LSB   0x01
#define AS5600_CONF_HYST_2LSB   0x02
#define AS5600_CONF_HYST_3LSB   0x03

#define AS5600_CONF_OUTS_ANALOG_0_100  0x00
#define AS5600_CONF_OUTS_ANALOG_10_90  0x01
#define AS5600_CONF_OUTS_PWM           0x02

#define AS5600_CONF_PWMF_115HZ     0x00
#define AS5600_CONF_PWMF_230HZ     0x01
#define AS5600_CONF_PWMF_460HZ     0x02
#define AS5600_CONF_PWMF_920HZ     0x03

#define AS5600_CONF_SF_16X     0x00
#define AS5600_CONF_SF_8X      0x01
#define AS5600_CONF_SF_4X      0x02
#define AS5600_CONF_SF_2X      0x03

#define AS5600_CONF_FTH_SFO    0x00
#define AS5600_CONF_FTH_1LSB   0x01
#define AS5600_CONF_FTH_2LSB   0x02
#define AS5600_CONF_FTH_3LSB   0x03
#define AS5600_CONF_FTH_4LSB   0x04
#define AS5600_CONF_FTH_5LSB   0x05
#define AS5600_CONF_FTH_6LSB   0x06
#define AS5600_CONF_FTH_7LSB   0x07

#define AS5600_CONF_WD_OFF     0x00
#define AS5600_CONF_WD_ON      0x01
